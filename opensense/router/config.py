...
class Settings(BaseModel):
    ...
    kafka_topic_matches: str = Field(default="eventscribe.matches", env="KAFKA_TOPIC_MATCHES")
...
def load_settings() -> Settings:
    ...
    env_vars.update({
        ...
        'KAFKA_TOPIC_MATCHES': os.getenv('KAFKA_TOPIC_MATCHES', 'eventscribe.matches'),
