...
from server.map.fingerprint import extract_type_skeleton, generate_fingerprint
...
class MappingEngine:
    ...
    async def apply_mapping(self, source: str, raw_payload: dict[str, Any]) -> dict[str, Any] | None:
        ...
        try:
            ...
            if matching_mappings:
                ...
                from server.map.fingerprint import generate_enhanced_fingerprint
    ...
    async def store_jsonata_mapping_with_event_field(
        ...
        """
        try:
            from server.map.fingerprint import (
