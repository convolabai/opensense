...
from server.subscriptions.llm import LLMPatternService, NoSuitableSchemaError
from server.subscriptions.schemas import (
            ...
            try:
                ...
                if need_gate_prompt and "gate_prompt" in result:
                    if update_data.gate is None:
                        from server.subscriptions.schemas import GateConfig
