...
async def create_subscription(
    ...
    try:
        ...
        if (
            "relation" in error_details.lower()
            and "does not exist" in error_details.lower()
        ):
...
async def list_subscriptions(
    ...
    try:
        ...
        subscriptions, total = await db_service.get_subscriber_subscriptions(
            subscriber_id=subscriber_id, skip=skip, limit=size
        )
...
async def update_subscription(
    subscription_id: int, update_data: SubscriptionUpdate
) -> SubscriptionResponse:
