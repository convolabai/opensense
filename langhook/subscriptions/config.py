...
class SubscriptionSettings(BaseModel):
    ...
    )  # openai, azure_openai, anthropic, google, local
    llm_api_key: str | None = Field(default=None, env="LLM_API_KEY")
    llm_model: str = Field(default="gpt-4", env="LLM_MODEL")
    llm_base_url: str | None = Field(
        default=None, env="LLM_BASE_URL"
    ...
    model_config = {"env_file": ".env.subscriptions", "env_file_encoding": "utf-8"}
    ...
    env_vars.update(
        {
            ...
            or os.getenv("OPENAI_API_KEY"),  # Backward compatibility
