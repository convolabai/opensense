...
class Settings(BaseModel):
    ...
    kafka_topic_canonical: str = Field(
        default="langhook.events", env="KAFKA_TOPIC_CANONICAL"
    )
    kafka_topic_matches: str = Field(
        default="langhook.matches", env="KAFKA_TOPIC_MATCHES"
    )
    ...
    model_config = {"env_file": ".env.router", "env_file_encoding": "utf-8"}
    ...
    env_vars.update(
        {
            ...
            "KAFKA_TOPIC_CANONICAL": os.getenv(
